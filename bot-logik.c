...
/*!
 * Das Verhalten dreht sich um 45ï¿½ in die angegebene Richtung (0=rechts, 1=links)
...
//	insert_behaviour_to_list(&behaviour, new_behaviour(250, bot_avoid_border_behaviour,ACTIVE));
	...
	insert_behaviour_to_list(&behaviour, new_behaviour(200, bot_glance_behaviour,INACTIVE));
	...
	insert_behaviour_to_list(&behaviour, new_behaviour(153, bot_turn_on_collect,INACTIVE));
	insert_behaviour_to_list(&behaviour, new_behaviour(152, bot_collect_obstacles_behaviour,INACTIVE));
	insert_behaviour_to_list(&behaviour, new_behaviour(151, bot_smooth_turn_behaviour,INACTIVE));
	...
	insert_behaviour_to_list(&behaviour, new_behaviour(147, bot_follow_line_behaviour,INACTIVE));
